...
>
      ...
      >
        <div
          style={{ transform }}
          className="absolute left-1/2 top-1/2 flex justify-start items-start p-4 rounded-2xl shadow-lg bg-black border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"
        >
        ...
        >
          {[0, 2, 4].map((delay, index) => (
            <motion.div
              ...
              className="absolute left-1/2 top-1/2 h-[11.25rem] w-[11.25rem] rounded-full bg-sky-500/[0.08] shadow-lg"
            />
          ))}
        </div>
